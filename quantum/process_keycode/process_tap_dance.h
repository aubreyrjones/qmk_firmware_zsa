...
#    define ACTION_TAP_DANCE_FN_FULL(user_fn_on_each_tap, user_fn_on_dance_finished, user_fn_on_dance_reset, userdata) \
        { .fn = {user_fn_on_each_tap, user_fn_on_dance_finished, user_fn_on_dance_reset}, .user_data = userdata, }        
